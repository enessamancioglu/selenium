...
import seleniumtest.enes.Pages.BasketPage;
import seleniumtest.enes.Pages.Header;
import seleniumtest.enes.Pages.LoginPage;
import seleniumtest.enes.Pages.ProductsPage;
...
public void step2_testLogin() throws InterruptedException {	
	...
	Thread.sleep(1000);
	loginPage.fillUsername("ginike9719@carpetd.com");
	loginPage.fillPassword("patpatpatp1334");
